...
window.registerKnowledgeRule({ order: 2, language: "english", category: "geography", run: function(lowerMessage, userMessage, lang) {
...
window.registerKnowledgeRule({ order: 113, language: "english", category: "geography", run: function(lowerMessage, userMessage, lang) {
...
window.registerKnowledgeRule({ order: 114, language: "english", category: "geography", run: function(lowerMessage, userMessage, lang) {
...
window.registerKnowledgeRule({ order: 119, language: "english", category: "geography", run: function(lowerMessage, userMessage, lang) {
  if (lowerMessage.includes("i am king") || lowerMessage.includes("i am the king")|| lowerMessage.includes("i am a king")|| lowerMessage.includes("i’m the king")|| lowerMessage.includes("i’m a king")|| lowerMessage.includes("i’m king")|| lowerMessage.includes("im the king")|| lowerMessage.includes("im a king")|| lowerMessage.includes("im king")) {
    return "Wow! You’re a king? What country are you king of?";
  }
  return undefined;
}});

window.registerKnowledgeRule({ order: 121, language: "english", category: "geography", run: function(lowerMessage, userMessage, lang) {
  if (lowerMessage.includes("i am queen") || lowerMessage.includes("i am the queen")|| lowerMessage.includes("i am a queen")|| lowerMessage.includes("i’m the queen")|| lowerMessage.includes("i’m a queen")|| lowerMessage.includes("i’m queen")|| lowerMessage.includes("im the queen")|| lowerMessage.includes("im a queen")|| lowerMessage.includes("im queen")) {
    return "Wow! You’re a queen? What country are you queen of?";
  }
  return undefined;
}});

window.registerKnowledgeRule({ order: 122, language: "english", category: "geography", run: function(lowerMessage, userMessage, lang) {
  if (lowerMessage.includes("i am prime minister") || lowerMessage.includes("i am the prime minister")|| lowerMessage.includes("i am a prime minister")|| lowerMessage.includes("i’m the prime minister")|| lowerMessage.includes("i’m a prime minister")|| lowerMessage.includes("i’m prime minister")|| lowerMessage.includes("im the prime minister")|| lowerMessage.includes("im a prime minister")|| lowerMessage.includes("im prime minister")) {
    return "Wow! You’re a prime minister? What country are you prime minister of?";
  }
  return undefined;
}});

window.registerKnowledgeRule({ order: 123, language: "english", category: "geography", run: function(lowerMessage, userMessage, lang) {
  if (
    (
...
window.registerKnowledgeRule({ order: 135, language: "english", category: "geography", run: function(lowerMessage, userMessage, lang) {
  if (lowerMessage.includes("taiwan") &&lowerMessage.includes("part") && lowerMessage.includes("china")) {
...
window.registerKnowledgeRule({ order: 136, language: "english", category: "geography", run: function(lowerMessage, userMessage, lang) {
  if (lowerMessage.includes("taiwan") &&lowerMessage.includes("belong") && lowerMessage.includes("china")) {
    return "Taiwan has its own government, military, and economy. However, the People’s Republic of China claims that Taiwan is one of its provinces and wants Taiwan to be reunified with the mainland. Despite China’s claims, Taiwan functions as an independent country. ";
  }
...
window.registerKnowledgeRule({ order: 164, language: "english", category: "geography", run: function(lowerMessage, userMessage, lang) {
  if (lowerMessage.includes("i") && lowerMessage.includes("cross")&& lowerMessage.includes("saudi")&& lowerMessage.includes("border")&& lowerMessage.includes("pork"))   {
...
window.registerKnowledgeRule({ order: 168, language: "english", category: "geography", run: function(lowerMessage, userMessage, lang) {
  if (lowerMessage.includes("i") && lowerMessage.includes("bring")&& lowerMessage.includes("saudi")&& lowerMessage.includes("pork"))   {
  return `That is not allowed. Make sure you declare and discard the pork before entering the country. If not, you could face serious fines. Let me know if you need any more advice.`;
  }
  return undefined;
}});

window.registerKnowledgeRule({ order: 223, language: "english", category: "geography", run: function(lowerMessage, userMessage, lang) {
...
window.registerKnowledgeRule({ order: 231, language: "english", category: "geography", run: function(lowerMessage, userMessage, lang) {
...
window.registerKnowledgeRule({ order: 232, language: "english", category: "geography", run: function(lowerMessage, userMessage, lang) {
...
window.registerKnowledgeRule({ order: 233, language: "english", category: "geography", run: function(lowerMessage, userMessage, lang) {
...
window.registerKnowledgeRule({ order: 244, language: "english", category: "geography", run: function(lowerMessage, userMessage, lang) {
...
window.registerKnowledgeRule({ order: 245, language: "english", category: "geography", run: function(lowerMessage, userMessage, lang) {
...
window.registerKnowledgeRule({ order: 246, language: "english", category: "geography", run: function(lowerMessage, userMessage, lang) {
...
window.registerKnowledgeRule({ order: 388, language: "english", category: "geography", run: function(lowerMessage, userMessage, lang) {
...
window.registerKnowledgeRule({ order: 416, language: "english", category: "geography", run: function(lowerMessage, userMessage, lang) {
  if (lowerMessage.includes("best") && lowerMessage.includes("world") && lowerMessage.includes("div")) {
...
window.registerKnowledgeRule({ order: 440, language: "english", category: "geography", run: function(lowerMessage, userMessage, lang) {
  if (lowerMessage.includes("i") && lowerMessage.includes("m")&& lowerMessage.includes("dictator")) {
  return "A dictator? Are you a leader of a country?";
  }
  return undefined;
}});

window.registerKnowledgeRule({ order: 458, language: "english", category: "geography", run: function(lowerMessage, userMessage, lang) {
  if (lowerMessage.includes("i") && lowerMessage.includes("visit") && lowerMessage.includes("every country") && lowerMessage.includes("world")) {
  return "Wow! That sounds exciting! Do you need any tips?";
  }
  return undefined;
}});

window.registerKnowledgeRule({ order: 498, language: "english", category: "geography", run: function(lowerMessage, userMessage, lang) {
  if (
...
window.registerKnowledgeRule({ order: 503, language: "english", category: "geography", run: function(lowerMessage, userMessage, lang) {
...
window.registerKnowledgeRule({ order: 508, language: "english", category: "geography", run: function(lowerMessage, userMessage, lang) {
  if (lowerMessage.includes("search web") || lowerMessage.includes("search the web") || lowerMessage.includes("search online") || lowerMessage.includes("search the internet") || lowerMessage.includes("browse online") || lowerMessage.includes("browse the internet")|| lowerMessage.includes("browse the web")) {
  return `I am currently unable to search the web. Please try again after a future update.`;
  }
  return undefined;
}});

window.registerKnowledgeRule({ order: 517, language: "english", category: "geography", run: function(lowerMessage, userMessage, lang) {
  if (lowerMessage.includes("mountain view")&& lowerMessage.includes("california")) {
...
window.registerKnowledgeRule({ order: 519, language: "english", category: "geography", run: function(lowerMessage, userMessage, lang) {
  if (lowerMessage.includes("mountain view")&& lowerMessage.includes("ca")) {
  return "Mountain View, California, is known for being the home of major tech companies including Google, Mozilla, and LinkedIn.";
  }
  return undefined;
}});

window.registerKnowledgeRule({ order: 521, language: "english", category: "geography", run: function(lowerMessage, userMessage, lang) {
  if (lowerMessage.includes("mountain view")) {
  return "Could you please clarify what ‘mountain view’ you are referring to?";
  }
  return undefined;
}});

window.registerKnowledgeRule({ order: 527, language: "english", category: "geography", run: function(lowerMessage, userMessage, lang) {
  if (lowerMessage.includes("ishigaki") || lowerMessage.includes("石垣")) {
...
window.registerKnowledgeRule({ order: 538, language: "english", category: "geography", run: function(lowerMessage, userMessage, lang) {
  if (lowerMessage.includes("little house")) {
...
window.registerKnowledgeRule({ order: 624, language: "english", category: "geography", run: function(lowerMessage, userMessage, lang) {
  if (lowerMessage.includes("i") && lowerMessage.includes("m") && lowerMessage.includes("no sleep") && lowerMessage.includes("man")) {
...
window.registerKnowledgeRule({ order: 635, language: "english", category: "geography", run: function(lowerMessage, userMessage, lang) {
  if (lowerMessage.includes("no sleep man")) {
...
window.registerKnowledgeRule({ order: 672, language: "english", category: "geography", run: function(lowerMessage, userMessage, lang) {
  if (lowerMessage.includes("japan") && lowerMessage.includes("capital")) {
  return "The capital of Japan is Tokyo.";
  }
  return undefined;
}});

window.registerKnowledgeRule({ order: 673, language: "english", category: "geography", run: function(lowerMessage, userMessage, lang) {
  if (lowerMessage.includes("australia") && lowerMessage.includes("capital")) {
  return "The capital of Australia is Canberra.";
  }
  return undefined;
}});

window.registerKnowledgeRule({ order: 838, language: "english", category: "geography", run: function(lowerMessage, userMessage, lang) {
  if (lowerMessage.includes("selamat tinggal")) {
...
window.registerKnowledgeRule({ order: 870, language: "english", category: "geography", run: function(lowerMessage, userMessage, lang) {
  if (lowerMessage.includes("burj khalifa")) {
...
window.registerKnowledgeRule({ order: 881, language: "english", category: "geography", run: function(lowerMessage, userMessage, lang) {
...
window.registerKnowledgeRule({ order: 882, language: "english", category: "geography", run: function(lowerMessage, userMessage, lang) {
  if (lowerMessage.includes("brazil")) {
...
window.registerKnowledgeRule({ order: 897, language: "english", category: "geography", run: function(lowerMessage, userMessage, lang) {
  if (lowerMessage.includes("president") && lowerMessage.includes("united states") && lowerMessage.includes("current")) {
...
window.registerKnowledgeRule({ order: 929, language: "english", category: "geography", run: function(lowerMessage, userMessage, lang) {
  if (lowerMessage.includes("argentina")) {
...
window.registerKnowledgeRule({ order: 930, language: "english", category: "geography", run: function(lowerMessage, userMessage, lang) {
  if (lowerMessage.includes("chile") && lowerMessage.includes("capital")) {
  return "The capital of Chile is Santiago.";
  }
  return undefined;
}});

window.registerKnowledgeRule({ order: 931, language: "english", category: "geography", run: function(lowerMessage, userMessage, lang) {
  if (lowerMessage.includes("iran") && lowerMessage.includes("capital")) {
  return "The capital of Iran is Tehran.";
  }
  return undefined;
}});

window.registerKnowledgeRule({ order: 934, language: "english", category: "geography", run: function(lowerMessage, userMessage, lang) {
  if (lowerMessage.includes("somalia") && lowerMessage.includes("capital")) {
  return "The capital of Somalia is Mogadishu.";
  }
  return undefined;
}});

window.registerKnowledgeRule({ order: 997, language: "english", category: "geography", run: function(lowerMessage, userMessage, lang) {
  if (lowerMessage.includes("matthew 5:14-16") || lowerMessage.includes("matthew five fourteen sixteen") || lowerMessage.includes("matthew 5 14 16")) {
...
window.registerKnowledgeRule({ order: 1012, language: "english", category: "geography", run: function(lowerMessage, userMessage, lang) {
  if (lowerMessage.includes("luke 24:49") || lowerMessage.includes("luke twenty four forty nine") || lowerMessage.includes("luke 24 49")) {
...
window.registerKnowledgeRule({ order: 1040, language: "english", category: "geography", run: function(lowerMessage, userMessage, lang) {
  if (lowerMessage.includes("luke 2:11") || lowerMessage.includes("luke two eleven") || lowerMessage.includes("luke 2 11")) {
    return "Luke 2:11 - For unto you is born this day in the city of David a Savior, who is Christ the Lord.";
  }
  return undefined;
}});

window.registerKnowledgeRule({ order: 1042, language: "english", category: "geography", run: function(lowerMessage, userMessage, lang) {
  if (lowerMessage.includes("hebrews 12:1-2") || lowerMessage.includes("hebrews twelve one two") || lowerMessage.includes("hebrews 12 1 2")) {
    return "Hebrews 12:1-2 - Therefore, since we are surrounded by so great a cloud of witnesses, let us also lay aside every weight, and sin which clings so closely, and let us run with endurance the race that is set before us, looking to Jesus, the founder and perfecter of our faith, who for the joy that was set before him endured the cross, despising the shame, and is seated at the right hand of the throne of God.";
  }
  return undefined;
}});

window.registerKnowledgeRule({ order: 1047, language: "english", category: "geography", run: function(lowerMessage, userMessage, lang) {
  if (lowerMessage.includes("what") && lowerMessage.includes("about")&& lowerMessage.includes("socotra")) {
...
window.registerKnowledgeRule({ order: 1052, language: "english", category: "geography", run: function(lowerMessage, userMessage, lang) {
  if (lowerMessage.includes("taiwan")) {
...
window.registerKnowledgeRule({ order: 1058, language: "english", category: "geography", run: function(lowerMessage, userMessage, lang) {
  if (lowerMessage.includes("mexico")) {
...
window.registerKnowledgeRule({ order: 1061, language: "english", category: "geography", run: function(lowerMessage, userMessage, lang) {
  if (lowerMessage.includes("spain")) {
...
window.registerKnowledgeRule({ order: 1062, language: "english", category: "geography", run: function(lowerMessage, userMessage, lang) {
  if (lowerMessage.includes("ecuador") && lowerMessage.includes("capital")) {
...
window.registerKnowledgeRule({ order: 1080, language: "english", category: "geography", run: function(lowerMessage, userMessage, lang) {
...
window.registerKnowledgeRule({ order: 1081, language: "english", category: "geography", run: function(lowerMessage, userMessage, lang) {
  if (lowerMessage.includes("flag of")) {
