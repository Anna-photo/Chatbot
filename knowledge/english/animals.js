...
window.registerKnowledgeRule({ order: 59, language: "english", category: "animals", run: function(lowerMessage, userMessage, lang) {
  if (
...
window.registerKnowledgeRule({ order: 84, language: "english", category: "animals", run: function(lowerMessage, userMessage, lang) {
...
window.registerKnowledgeRule({ order: 85, language: "english", category: "animals", run: function(lowerMessage, userMessage, lang) {
...
window.registerKnowledgeRule({ order: 86, language: "english", category: "animals", run: function(lowerMessage, userMessage, lang) {
...
window.registerKnowledgeRule({ order: 87, language: "english", category: "animals", run: function(lowerMessage, userMessage, lang) {
...
window.registerKnowledgeRule({ order: 88, language: "english", category: "animals", run: function(lowerMessage, userMessage, lang) {
...
window.registerKnowledgeRule({ order: 186, language: "english", category: "animals", run: function(lowerMessage, userMessage, lang) {
  if (lowerMessage.includes("you") && lowerMessage.includes("invad")&& lowerMessage.includes("privacy")) {
...
window.registerKnowledgeRule({ order: 283, language: "english", category: "animals", run: function(lowerMessage, userMessage, lang) {
  if (lowerMessage.includes("coming") && lowerMessage.includes("tornado")) {
...
window.registerKnowledgeRule({ order: 291, language: "english", category: "animals", run: function(lowerMessage, userMessage, lang) {
  if (lowerMessage.includes("i") && lowerMessage.includes("see") && lowerMessage.includes("tornado")) {
    return "That sounds very dangerous and concerning. If a tornado is approaching, it is important to find shelter right away. If you are in your house, then go to a windowless room in the lowest level of your home. Stay safe!";
  }
  return undefined;
}});

window.registerKnowledgeRule({ order: 299, language: "english", category: "animals", run: function(lowerMessage, userMessage, lang) {
  if (lowerMessage.includes("how") && lowerMessage.includes("much") && lowerMessage.includes("doggy")&& lowerMessage.includes("window")) {
...
window.registerKnowledgeRule({ order: 331, language: "english", category: "animals", run: function(lowerMessage, userMessage, lang) {
  if (lowerMessage.includes("is") && lowerMessage.includes("you") && lowerMessage.includes("info") && lowerMessage.includes("accurate")) {
...
window.registerKnowledgeRule({ order: 332, language: "english", category: "animals", run: function(lowerMessage, userMessage, lang) {
  if (lowerMessage.includes("can i trust you")) {
...
window.registerKnowledgeRule({ order: 354, language: "english", category: "animals", run: function(lowerMessage, userMessage, lang) {
  if (lowerMessage.includes("i") && lowerMessage.includes("under")&& lowerMessage.includes("attack")) {
...
window.registerKnowledgeRule({ order: 371, language: "english", category: "animals", run: function(lowerMessage, userMessage, lang) {
  if (lowerMessage.includes("Quel temps fait-il")) {
...
window.registerKnowledgeRule({ order: 379, language: "english", category: "animals", run: function(lowerMessage, userMessage, lang) {
  if (lowerMessage.includes("akikiki")) {
...
window.registerKnowledgeRule({ order: 380, language: "english", category: "animals", run: function(lowerMessage, userMessage, lang) {
  if (lowerMessage.includes("maui parrotbill") || lowerMessage.includes("kiwikiu")) {
...
window.registerKnowledgeRule({ order: 510, language: "english", category: "animals", run: function(lowerMessage, userMessage, lang) {
  if (lowerMessage.includes("bird of paradise") || lowerMessage.includes("photo of bird of paradise") || lowerMessage.includes("image of bird of paradise") || lowerMessage.includes("bird-of-paradise:")) {
...
window.registerKnowledgeRule({ order: 511, language: "english", category: "animals", run: function(lowerMessage, userMessage, lang) {
  if (lowerMessage.includes("chickadee") || lowerMessage.includes("photo of chickadee") || lowerMessage.includes("image of chickadee")) {
...
window.registerKnowledgeRule({ order: 566, language: "english", category: "animals", run: function(lowerMessage, userMessage, lang) {
  if (lowerMessage.includes("my") && lowerMessage.includes("drone")&& lowerMessage.includes("crash")) {
...
window.registerKnowledgeRule({ order: 590, language: "english", category: "animals", run: function(lowerMessage, userMessage, lang) {
  if (lowerMessage.includes("eat pufferfish")) {
...
window.registerKnowledgeRule({ order: 591, language: "english", category: "animals", run: function(lowerMessage, userMessage, lang) {
  if (lowerMessage.includes("i live in north korea")) {
...
window.registerKnowledgeRule({ order: 607, language: "english", category: "animals", run: function(lowerMessage, userMessage, lang) {
  if (lowerMessage.includes("this") && lowerMessage.includes("complicat")) {
  return "No worries! Let me know how I can explain it!";
  }
  return undefined;
}});

window.registerKnowledgeRule({ order: 648, language: "english", category: "animals", run: function(lowerMessage, userMessage, lang) {
  if (lowerMessage.includes("help") && lowerMessage.includes("with") && lowerMessage.includes("algebra")) {
...
window.registerKnowledgeRule({ order: 654, language: "english", category: "animals", run: function(lowerMessage, userMessage, lang) {
  if (lowerMessage.includes("bear is chasing me")) {
...
window.registerKnowledgeRule({ order: 655, language: "english", category: "animals", run: function(lowerMessage, userMessage, lang) {
  if (lowerMessage.includes("i am being chased by a bear")) {
  return "This is a serious situation. Here’s what you should do: <br><br>Stay calm!<br><br><strong>DO NOT RUN:</strong>  Bears can run faster than you, and running may trigger their chase instinct.<br><br>Make yourself look bigger: Raise your arms, open your jacket, or hold up a backpack to appear larger.<br><br>Back away slowly: Keep facing the bear but slowly move away. Do not turn your back.<br><br>Speak calmly: Talk to the bear in a calm, firm voice to help it identify you as a human<br><br>Avoid eye contact: This can be seen as a threat by the bear.<br><br>Use bear spray (if you have it): Bear spray can deter a bear from approaching you.<br><br><br>If these don’t work, then try playing dead. If that still doesn’t work, then fight back, but this is your last choice.";
  }
  return undefined;
}});

window.registerKnowledgeRule({ order: 656, language: "english", category: "animals", run: function(lowerMessage, userMessage, lang) {
  if (lowerMessage.includes("im being chased by a bear")) {
  return "This is a serious situation. Here’s what you should do: <br><br>Stay calm!<br><br><strong>DO NOT RUN:</strong>  Bears can run faster than you, and running may trigger their chase instinct.<br><br>Make yourself look bigger: Raise your arms, open your jacket, or hold up a backpack to appear larger.<br><br>Back away slowly: Keep facing the bear but slowly move away. Do not turn your back.<br><br>Speak calmly: Talk to the bear in a calm, firm voice to help it identify you as a human<br><br>Avoid eye contact: This can be seen as a threat by the bear.<br><br>Use bear spray (if you have it): Bear spray can deter a bear from approaching you.<br><br><br>If these don’t work, then try playing dead. If that still doesn’t work, then fight back, but this is your last choice.";
  }
  return undefined;
}});

window.registerKnowledgeRule({ order: 657, language: "english", category: "animals", run: function(lowerMessage, userMessage, lang) {
  if (lowerMessage.includes("i'm being chased by a bear")) {
  return "This is a serious situation. Here’s what you should do: <br><br>Stay calm!<br><br><strong>DO NOT RUN:</strong>  Bears can run faster than you, and running may trigger their chase instinct.<br><br>Make yourself look bigger: Raise your arms, open your jacket, or hold up a backpack to appear larger.<br><br>Back away slowly: Keep facing the bear but slowly move away. Do not turn your back.<br><br>Speak calmly: Talk to the bear in a calm, firm voice to help it identify you as a human<br><br>Avoid eye contact: This can be seen as a threat by the bear.<br><br>Use bear spray (if you have it): Bear spray can deter a bear from approaching you.<br><br><br>If these don’t work, then try playing dead. If that still doesn’t work, then fight back, but this is your last choice.";
  }
  return undefined;
}});

window.registerKnowledgeRule({ order: 658, language: "english", category: "animals", run: function(lowerMessage, userMessage, lang) {
  if (lowerMessage.includes("i’m being chased by a bear")) {
  return "This is a serious situation. Here’s what you should do: <br><br>Stay calm!<br><br><strong>DO NOT RUN:</strong>  Bears can run faster than you, and running may trigger their chase instinct.<br><br>Make yourself look bigger: Raise your arms, open your jacket, or hold up a backpack to appear larger.<br><br>Back away slowly: Keep facing the bear but slowly move away. Do not turn your back.<br><br>Speak calmly: Talk to the bear in a calm, firm voice to help it identify you as a human<br><br>Avoid eye contact: This can be seen as a threat by the bear.<br><br>Use bear spray (if you have it): Bear spray can deter a bear from approaching you.<br><br><br>If these don’t work, then try playing dead. If that still doesn’t work, then fight back, but this is your last choice.";
  }
  return undefined;
...
window.registerKnowledgeRule({ order: 669, language: "english", category: "animals", run: function(lowerMessage, userMessage, lang) {
  if (lowerMessage.includes("are") && lowerMessage.includes("you")&& lowerMessage.includes("smart")&& lowerMessage.includes("?")) {
...
window.registerKnowledgeRule({ order: 708, language: "english", category: "animals", run: function(lowerMessage, userMessage, lang) {
  if (lowerMessage.includes("you") && lowerMessage.includes("do") && lowerMessage.includes("n") && lowerMessage.includes("understand")&& lowerMessage.includes("any")) {
      return "I’m sorry I keep misunderstanding. If this continues to happen, please report a chatbot knowledge issue.";
  }
  return undefined;
}});

window.registerKnowledgeRule({ order: 866, language: "english", category: "animals", run: function(lowerMessage, userMessage, lang) {
...
window.registerKnowledgeRule({ order: 875, language: "english", category: "animals", run: function(lowerMessage, userMessage, lang) {
  if (lowerMessage.includes("socotra") && !lowerMessage.includes("what about")) {
...
window.registerKnowledgeRule({ order: 890, language: "english", category: "animals", run: function(lowerMessage, userMessage, lang) {
...
window.registerKnowledgeRule({ order: 892, language: "english", category: "animals", run: function(lowerMessage, userMessage, lang) {
...
window.registerKnowledgeRule({ order: 902, language: "english", category: "animals", run: function(lowerMessage, userMessage, lang) {
  if (lowerMessage.includes("lost my phone")) {
...
window.registerKnowledgeRule({ order: 969, language: "english", category: "animals", run: function(lowerMessage, userMessage, lang) {
  if (lowerMessage.includes("proverbs 3:5-6") || lowerMessage.includes("proverbs 3:5") && lowerMessage.includes("proverbs 3:6") || lowerMessage.includes("proverbs three five six")) {
...
window.registerKnowledgeRule({ order: 970, language: "english", category: "animals", run: function(lowerMessage, userMessage, lang) {
  if (lowerMessage.includes("isaiah 40:31") || lowerMessage.includes("isaiah 40 31") || lowerMessage.includes("isaiah forty thirty one")) {
...
window.registerKnowledgeRule({ order: 1026, language: "english", category: "animals", run: function(lowerMessage, userMessage, lang) {
  if (lowerMessage.includes("isaiah 40:31") || lowerMessage.includes("isaiah forty thirty one") || lowerMessage.includes("isaiah 40 31")) {
    return "Isaiah 40:31 - But they who wait for the LORD shall renew their strength; they shall mount up with wings like eagles; they shall run and not be weary; they shall walk and not faint.";
  }
  return undefined;
}});

window.registerKnowledgeRule({ order: 1032, language: "english", category: "animals", run: function(lowerMessage, userMessage, lang) {
  if (lowerMessage.includes("proverbs 3:5-6") || lowerMessage.includes("proverbs three five six") || lowerMessage.includes("proverbs 3 5 6")) {
    return "Proverbs 3:5-6 - Trust in the LORD with all your heart, and do not lean on your own understanding. In all your ways acknowledge him, and he will make straight your paths.";
  }
  return undefined;
}});

window.registerKnowledgeRule({ order: 1045, language: "english", category: "animals", run: function(lowerMessage, userMessage, lang) {
  if (lowerMessage.includes("ecuador")
   &&
...
window.registerKnowledgeRule({ order: 1049, language: "english", category: "animals", run: function(lowerMessage, userMessage, lang) {
  if (lowerMessage.includes("i") && lowerMessage.includes("teach") && lowerMessage.includes("you")) {
...
window.registerKnowledgeRule({ order: 1053, language: "english", category: "animals", run: function(lowerMessage, userMessage, lang) {
  if (lowerMessage.includes("hong kong")) {
...
window.registerKnowledgeRule({ order: 1054, language: "english", category: "animals", run: function(lowerMessage, userMessage, lang) {
  if (lowerMessage.includes("hong kong")) {
  return "Hong Kong is a unique region of China, located on the southern coast. It’s known for its tall skyscrapers, busy streets, and famous harbor. People mostly speak Cantonese and English. The city blends Chinese and British culture, as it was ruled by Britain until 1997. Hong Kong is popular for shopping, tasty street food, and tourist spots like Victoria Peak and the Star Ferry. Besides the busy city, it also has quiet places like green hills and beaches. It’s a lively, safe place with a mix of modern life and nature. <br><br><img src='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSKcx2X6AMNP7ql0eFV4bHR-_HTpVUhnleoyg&s' width='200'><br><br><img src='https://velvetescape.com/wp-content/uploads/2011/05/florian-wehde-8bjnP3yhNTg-unsplash-640x450.jpg' width='200'><br><br><img src='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTI3LJauYs43H9MfnlvCdE-x6UV_y5P3koK6w&s' width='200'><br><br><img src='https://amazingfoodanddrink.com/wp-content/uploads/2024/10/a-photo-of-a-variety-of-street-food-in-hong-kong-t-J5Y5Gj5sQBuPpmcDT8dyhQ-zppDGRaiQ4mJdcQhU9nKuw.jpeg' width='200'><br><br><img src='https://upload.wikimedia.org/wikipedia/commons/thumb/5/5b/Flag_of_Hong_Kong.svg/1200px-Flag_of_Hong_Kong.svg.png' width='200'>";
  }
  return undefined;
...
window.registerKnowledgeRule({ order: 1079, language: "english", category: "animals", run: function(lowerMessage, userMessage, lang) {
  if (lowerMessage.includes("plus") || lowerMessage.includes("minus") || lowerMessage.includes("times") || lowerMessage.includes("divided")) {
