...
window.registerKnowledgeModule({ language: 'english', category: 'travel', run: function(lowerMessage, userMessage, lang) {
  ...
  else if (lowerMessage.includes("i") && lowerMessage.includes("visiting") && lowerMessage.includes("japan")) {
    return "Have fun in Japan! Safe travels! ✈️🧳🌏";
    }
  else if (lowerMessage.includes("anthem") && lowerMessage.includes("united states")) {
  ...
  else if (lowerMessage.includes("star") && lowerMessage.includes("spangled banner")) {
        return "<h2 style='display: flex; align-items: center; justify-content: center;'>" +
               "<img src='https://flagpedia.net/data/flags/h80/us.png' alt='USA Flag' style='width: 40px; margin-right: 10px;'>" +
  ...
  else if (lowerMessage.includes("anthem") && lowerMessage.includes("america")) {
        return "<h2 style='display: flex; align-items: center; justify-content: center;'>" +
               "<img src='https://flagpedia.net/data/flags/h80/us.png' alt='USA Flag' style='width: 40px; margin-right: 10px;'>" +
               "The Star-Spangled Banner</h2>" +
               "<i>O say can you see, by the dawn's early light,<br>" +
  ...
  else if (lowerMessage.includes("anthem") && lowerMessage.includes("usa")) {
        return "<h2 style='display: flex; align-items: center; justify-content: center;'>" +
               "<img src='https://flagpedia.net/data/flags/h80/us.png' alt='USA Flag' style='width: 40px; margin-right: 10px;'>" +
               "The Star-Spangled Banner</h2>" +
               "<i>O say can you see, by the dawn's early light,<br>" +
