// Chatbot Version 7 knowledge — cantonese / science
...
window.registerKnowledgeModule({ language: 'cantonese', category: 'science', run: function(lowerMessage, userMessage, lang) {
  if (lowerMessage.includes("太空人") && lowerMessage.includes("變")) {
