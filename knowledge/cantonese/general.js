...
window.registerKnowledgeModule({ language: 'cantonese', category: 'general', run: function(lowerMessage, userMessage, lang) {
  ...
  else if (lowerMessage.includes("你係咪chatgpt")||lowerMessage.includes("你係咪chat gpt")) {
      return "唔係，我係一個對話機械人，但唔係ChatGPT。我覺得我仲勁過ChatGPT，我目標係做全世界最叻嘅機械人。";
    }
  else if (lowerMessage.includes("我") && lowerMessage.includes("去") && lowerMessage.includes("杜拜")) {
  ...
  else if (lowerMessage.includes("你") && lowerMessage.includes("叫") && lowerMessage.includes("我") && lowerMessage.includes("小偷")) {
  ...
  else if (lowerMessage.includes("我") && lowerMessage.includes("獨裁")) {
