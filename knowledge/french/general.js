...
window.registerKnowledgeModule({ language: 'french', category: 'general', run: function(lowerMessage, userMessage, lang) {
  ...
  else if (lowerMessage.includes("anthem") && lowerMessage.includes("france")) {
