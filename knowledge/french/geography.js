...
window.registerKnowledgeRule({ order: 653, language: "french", category: "geography", run: function(lowerMessage, userMessage, lang) {
...
window.registerKnowledgeRule({ order: 889, language: "french", category: "geography", run: function(lowerMessage, userMessage, lang) {
...
window.registerKnowledgeRule({ order: 1070, language: "french", category: "geography", run: function(lowerMessage, userMessage, lang) {
  if (
