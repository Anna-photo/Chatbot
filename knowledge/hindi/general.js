...
window.registerKnowledgeModule({ language: 'hindi', category: 'general', run: function(lowerMessage, userMessage, lang) {
  ...
  else if (lowerMessage.includes("anthem") && lowerMessage.includes("india")) {
