...
window.registerKnowledgeModule({ language: 'mandarin', category: 'geography', run: function(lowerMessage, userMessage, lang) {
  ...
  else if (lowerMessage.includes("anthem") && lowerMessage.includes("china")) {
        return "<h2 style='display: flex; align-items: center; justify-content: center;'>" +
